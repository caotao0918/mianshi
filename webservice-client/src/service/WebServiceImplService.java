 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8089/webservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://service/", "WebServiceImplService");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://service/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
